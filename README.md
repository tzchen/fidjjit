...
For chrome users, unsafe scripts must be allowed to load, as the page contains mixed content between the UW https server and the http server set up by our team.
